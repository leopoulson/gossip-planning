...
*** Refer back to benefits of Haskell each time
**** Model
...
** Ch 5 - Evaluation
*** TODO Address non-agreeing results for certain graphs
    Only for *certain* graphs. Mention why this may be / why this isn't a problem
...
*** DONE Restructure conclusion; put each criticism into a section? 
    CLOSED: [2019-05-07 Tue 11:07]
** Ch 6 - Conclusion
*** TODO Add analysis of done stuff
